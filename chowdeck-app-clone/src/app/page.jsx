...
export default function Home() {
  ...
  return (
    <div>
      ...
      :<div className='w-screen h-screen flex-center justify-center bg-bg-body absolute top-0 left-0 z-[99999999]'><h2 className='text-xl'>My Responsiveness Is Being Worked Upon...</h2></div>}
